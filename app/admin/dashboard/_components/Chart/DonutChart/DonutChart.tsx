...
import { DonutChartDataOptions, DonutChartDataSeries } from "./DonutChartData";

function DonutChart() {
  const [options, setOptions] = React.useState<ApexCharts.ApexOptions>(
    DonutChartDataOptions
  );
  const [series, setSeries] = React.useState(DonutChartDataSeries);
  return (
    <div className=" w-[73%] flex items-start flex-col justify-between  bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
      <div className="flex justify-between w-full mb-3">
        ...
        <div>
          <button
            ...
            className="hidden sm:inline-flex items-center justify-center self-end text-gray-500 w-8 h-8 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm"
          >
            <svg
      ...
      <Chart
        ...
        height={320}
      ></Chart>
      <div className="grid grid-cols-1 w-full items-center border-gray-200 border-t dark:border-gray-700 justify-between">
