...
import AllBlogsTable, {
	AllBlogsTableInteraction,
} from "./_components/AllBlogsTable/AllBlogsTable";
...
function admin() {
	...
	const interactionRef = useRef<{
		blogsTableInteraction: AllBlogsTableInteraction | null;
	}>({
		blogsTableInteraction: null,
	}).current;
			...
			<section className="p-8 w-full gap-[39px] flex flex-col">
				...
				<div className="w-full flex-col gap-[39px] flex items-center justify-between">
					<div className="relative w-full">
						...
						<input
							onChange={(e) => {
								interactionRef.blogsTableInteraction?.filterRecordsFromQuery(
									e.target.value
								);
							}}
							type="text"
				...
				<div className="flex flex-col gap-5 w-full">
					...
					<AllBlogsTable
						setInteraction={(v) => {
							interactionRef.blogsTableInteraction = v;
						}}
					/>
				</div>
			</section>
