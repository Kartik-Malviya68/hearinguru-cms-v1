import addNewAuthor from "@/app/admin/dashboard/manageWebsite/blogs/_fetch/services/addNewAuthor";
...
export default function AddNewAuthorModal(props: AddNewAuthorModalProps) {
  const { isOpen, closeModal } = props;
  const [state, loading, fetch] = useHandleAsync(addNewAuthor, {
    onSuccess: () => {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<BlogTypes.AddNewAuthor>();

  const onSubmit: SubmitHandler<BlogTypes.AddNewAuthor> = (data) => {
    fetch(data);
    console.log(data);
  };
  return (
